...
# Helper: run shell command async, streaming stdout line-by-line
...
async def websocket_clone(websocket: WebSocket):
    ...
    try:
        ...
        # Placeholder for AI analysis logic streaming progress
...
async def clone_analyze_background(repo: RepoUrl, background_tasks: BackgroundTasks):
    ...
    try:
        ...
        # Kick off async AI analysis in background
...
async def dummy_ai_analysis(project_path):
    ...
    # Here, inject your AI analysis logic, updates, logs, etc.
